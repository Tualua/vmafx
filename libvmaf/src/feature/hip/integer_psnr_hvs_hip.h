 ...
 *
 *  HIP host glue for the psnr_hvs feature extractor.
 *  Mirrors `libvmaf/src/feature/cuda/integer_psnr_hvs_cuda.h`.
 ...
 * `libvmaf/src/feature/cuda/integer_psnr_hvs_cuda.h`.
 */
