...
class AssetTest(MyTestCase):
    ...
    def test_ref_width_height(self):
        ...
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"ref_width": 1920, "ref_height": 1080, "width": 720, "height": 480},
        )
        self.assertEqual(asset.ref_width_height, (1920, 1080))
    ...
    def test_dis_width_height(self):
        ...
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"dis_width": 1920, "dis_height": 1080, "width": 720, "height": 480},
        )
        self.assertEqual(asset.dis_width_height, (1920, 1080))
    ...
    def test_quality_width_height(self):
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"ref_width": 1920, "ref_height": 1080, "dis_width": 720, "dis_height": 480},
        )
        with self.assertRaises(AssertionError):
    ...
    def test_bitrate(self):
        ...
        self.assertAlmostEqual(asset.ref_bitrate_kbps_for_entire_file, 53693.964287999996, places=4)
        self.assertAlmostEqual(asset.dis_bitrate_kbps_for_entire_file, 53693.964287999996, places=4)
    ...
    def test_str_repr(self):
        ...
        self.assertEqual(str(asset), "test_0_1_refvideo_720x480_vs_disvideo_720x480_q_720x480")
        ...
        asset = Asset(
            ...
            ref_path="dir/refvideo.yuv",
            dis_path="dir/disvideo.yuv",
            asset_dict={"width": 720, "height": 480, "dis_enc_width": 1920, "dis_enc_height": 1080},
        )
        self.assertEqual(
    ...
    def test_str(self):
        ...
        asset = Asset(
            ...
            ref_path="dir/refvideo.yuv",
            dis_path="dir/disvideo.yuv",
            asset_dict={"width": 720, "height": 480, "quality_width": 720, "quality_height": 480},
        )
        self.assertEqual(str(asset), "test_0_1_refvideo_720x480_vs_disvideo_720x480_q_720x480")
        ...
        asset = Asset(
            ...
            ref_path="dir/refvideo.yuv",
            dis_path="dir/disvideo.yuv",
            asset_dict={"width": 720, "height": 480, "resampling_type": "lanczos"},
        )
        self.assertEqual(str(asset), "test_0_1_refvideo_720x480_vs_disvideo_720x480_q_720x480")
        ...
        self.assertEqual(
            str(asset), "test_0_1_refvideo_1920x1080_lanczos_vs_disvideo_720x480_q_720x480"
        )
        ...
        asset = Asset(
            ...
            ref_path="dir/refvideo.yuv",
            dis_path="dir/disvideo.yuv",
            asset_dict={"width": 720, "height": 480, "dis_enc_width": 480, "dis_enc_height": 320},
        )
        self.assertEqual(
            str(asset), "test_0_1_refvideo_720x480_vs_disvideo_720x480_e_480x320_q_720x480"
        )
        ...
        self.assertEqual(
            str(asset), "test_0_1_refvideo_720x480_vs_disvideo_720x480_ebd_8_yuv420p10le_q_720x480"
        )
        ...
        asset = Asset(
            ...
            ref_path="dir/refvideo.yuv",
            dis_path="dir/disvideo.yuv",
            asset_dict={"width": 720, "height": 480, "workfile_yuv_type": "yuv420p10le"},
        )
        self.assertEqual(
    ...
    def test_hash_equal(self):
        ...
        asset3 = Asset(
            ...
            content_id=0,
            asset_id=2,
            ref_path="my/dir/refvideo.yuv",
            dis_path="my/dir/disvideo.yuv",
            asset_dict={"width": 720, "height": 480, "quality_width": 1920, "quality_height": 1080},
        )
        asset4 = Asset(
            dataset="test",
    ...
    def test_yuv_type(self):
        ...
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"fps": 24, "start_sec": 2, "end_sec": 3, "yuv_type": "yuv444p"},
        )
        ...
        with self.assertRaises(AssertionError):
            asset = Asset(
                ...
                ref_path="",
                dis_path="",
                asset_dict={"fps": 24, "start_sec": 2, "end_sec": 3, "yuv_type": "yuv444a"},
            )
    ...
    def test_resampling_type(self):
        ...
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"fps": 24, "start_sec": 2, "end_sec": 3, "resampling_type": "lanczos"},
        )
        ...
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"fps": 24, "start_sec": 2, "end_sec": 3, "resampling_type": "bicubic"},
        )
        self.assertEqual(asset.ref_resampling_type, "bicubic")
        self.assertEqual(asset.dis_resampling_type, "bicubic")
    ...
    def test_crop_cmd(self):
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_720x480_yuv422p_crop570_320_3_2_vs_720x480_yuv422p_crop570_320_3_2_q_720x320",
        )
    ...
    def test_ref_dis_crop_cmd(self):
        asset = Asset(
            ...
            asset_dict={
                ...
                "quality_height": 320,
                "yuv_type": "yuv422p",
                "ref_crop_cmd": "570:320:3:2",
                "dis_crop_cmd": "571:320:3:2",
            },
        )
        self.assertTrue(asset.crop_cmd is None)
        self.assertEqual(asset.ref_crop_cmd, "570:320:3:2")
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_720x480_yuv422p_crop570_320_3_2_vs_720x480_yuv422p_crop571_320_3_2_q_720x320",
        )
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_720x480_yuv422p_crop570_320_3_2_vs_720x480_yuv422p_crop572_320_3_2_q_720x320",
        )
    ...
    def test_pad_cmd(self):
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_720x480_yuv422p_padiw_6_ih_4_3_2_vs_720x480_yuv422p_padiw_6_ih_4_3_2_q_720x320",
        )
    ...
    def test_ref_dis_pad_cmd(self):
        ...
        self.assertEqual(
            str(asset), "test_0_0_720x480_yuv422p_padiw_6_ih_4_3_2_vs_720x480_yuv422p_q_720x320"
        )
    ...
    def test_fps_cmd(self):
        ...
        self.assertEqual(
            str(asset), "test_0_0_720x480_yuv422p_fps120_vs_720x480_yuv422p_fps120_q_720x320"
        )
    ...
    def test_notyuv(self):
        ...
        asset = Asset(
            ...
            ref_path="",
            dis_path="",
            asset_dict={"yuv_type": "notyuv", "workfile_yuv_type": "yuv422p"},
        )
    ...
    def test_gblur_cmd(self):
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_720x480_yuv422p_gblursigma_1_steps_2_vs_720x480_yuv422p_gblursigma_1_steps_2_q_720x320",
        )
    ...
    def test_ref_dis_gblur_cmd(self):
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_720x480_yuv422p_gblursigma_1_steps_2_vs_720x480_yuv422p_gblursigma_0_3_steps_3_q_720x320",
        )
    ...
    def test_long_string(self):
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_720x480_yuv422p_q_720x320",
        )
        ...
        self.assertEqual(
            str(asset),
            "test_0_0_bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb_720x480_yuv422p_q_720x320",
        )
    ...
    def test_crop_pad_special(self):
        ...
        asset = Asset(
            ...
            asset_dict={
                ...
                "ref_pad_cmd": "iw+0:ih+280:0:140",
                "ref_start_frame": 0,
                "ref_end_frame": 2,
                "dis_yuv_type": "notyuv",
                "dis_start_frame": 114629,
                "dis_end_frame": 114629 + 2,
                "quality_width": 1920,
                "quality_height": 1080,
