...
class VmafexecQualityRunnerTest(MyTestCase):
    ...
    def test_run_vmafexec_runner_matched_to_vmafossexec(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale1_score"], 0.7674952820232231, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale2_score"], 0.8631077727416296, places=4
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_ssim_score"], 0.86322654166666657, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_ms_ssim_score"], 0.9632406874999999, places=4
        )
    ...
    def test_run_vmafexec_runner_float_fex(self):
        ...
        self.assertAlmostEqual(results[1]["VMAFEXEC_vif_scale0_score"], 1.0, places=4)
        self.assertAlmostEqual(
            results[1]["VMAFEXEC_vif_scale1_score"], 0.9999998541666666, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAFEXEC_vif_scale2_score"], 0.9999996041666667, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmafexec_runner_set_custom_models(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            optional_dict={
                "models": [
                    "path={}:name=custom_vmaf_0".format(
                        VmafConfig.model_path("vmaf_float_v0.6.1.json")
                    ),
                    "path={}:name=custom_vmaf_1".format(
                        VmafConfig.model_path("vmaf_float_v0.6.1.json")
                    ),
                ]
            },
        ...
        self.assertAlmostEqual(
            results[1]["VMAFEXEC_custom_vmaf_1_score"], 99.94641666666666, places=4
        )
    ...
    def test_run_vmafexec_runner_set_custom_models_enable_transform(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            optional_dict={
                "models": [
                    "path={}:name=standvmaf".format(
                        VmafConfig.model_path("vmaf_float_v0.6.1.json")
                    ),
                    "path={}:name=phonevmaf:enable_transform".format(
                        VmafConfig.model_path("vmaf_float_v0.6.1.json")
                    ),
                ]
            },
    ...
    def test_run_vmafexec_runner_yuv420p10le_b(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale0_score"], 0.4330893333333334, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_ssim_score"], 0.8978630000000001, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_ms_ssim_score"], 0.9747490000000001, places=4
        )
    ...
    def test_run_vmafexec_runner_yuv420p10le_sparks(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale1_score"], 0.9968371999999999, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale2_score"], 0.9987575999999999, places=4
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_ms_ssim_score"], 0.9993778000000001, places=4
        )

        self.assertAlmostEqual(results[1]["VMAFEXEC_vif_scale0_score"], 1.0, places=4)
        self.assertAlmostEqual(
            results[1]["VMAFEXEC_vif_scale1_score"], 0.9999990000000001, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAFEXEC_vif_scale2_score"], 0.9999990000000001, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmafexec_runner_float_moment(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_moment_ref1st_score"], 59.788567354166666, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_moment_dis1st_score"], 61.332006625, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_moment_ref2nd_score"], 4696.668388125, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_float_moment_dis2nd_score"], 4798.659574041666, places=4
        )
    ...
    def test_run_vmafexec_runner_akiyo_multiply(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm2_score"], 1.116691, places=4
        )  # 1.116691484215469
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale0_score"], 1.052403, places=4
        )  # 1.0522544319369052
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale1_score"], 1.070149, places=4
        )  # 1.0705609423182443
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale2_score"], 1.072518, places=4
        )  # 1.0731529493098957
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale3_score"], 1.072512, places=4
        )  # 1.0728060231246508
    ...
    def test_run_vmafexec_runner_akiyo_multiply_with_feature_enhn_gain_limit_custom(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale0_egl_1.1_score"], 1.029842, places=4
        )  # 1.0522544319369052
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale1_egl_1.1_score"], 1.046578, places=4
        )  # 1.0705609423182443
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale2_egl_1.1_score"], 1.04852, places=4
        )  # 1.0731529493098957
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_vif_scale3_egl_1.1_score"], 1.04892, places=4
        )  # 1.0728060231246508
    ...
    def test_run_vmafexec_runner_akiyo_multiply_no_enhn_gain_model(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            optional_dict={
                "disable_clip_score": True,
                "model_filepath": VmafConfig.model_path("vmaf_v0.6.1neg.json"),
            },
        )
        self.runner.run(parallelize=True)
    ...
    def test_run_vmafexec_runner_akiyo_multiply_no_enhn_gain_model_and_cmd_options_illegal(self):
        ...
        with self.assertRaises(
            AssertionError, msg="adm_enhn_gain_limit is below 1 but the exception is not raised"
        ):
            self.runner.run(parallelize=False)
    ...
    def test_run_vmafexec_runner_akiyo_multiply_no_enhn_gain_model_and_cmd_options_illegal2(self):
        ...
        with self.assertRaises(
            AssertionError, msg="vif_enhn_gain_limit is below 1 but the exception is not raised"
        ):
            self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_with_transform_score(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            optional_dict={
                "models": [
                    "path={}:name=vmat:enable_transform".format(
                        VmafConfig.test_resource_path("test_model_transform_add40.json")
                    ),
                ],
            },
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm_scale0_score"], 0.23738393128710478, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm_scale1_score"], 0.08524788663335138, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm_scale2_score"], 0.024058909404945077, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm_scale3_score"], 0.018034879735107798, places=4
        )
    ...
    def test_run_vmaf_runner_with_transform_score_2(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            optional_dict={
                "models": [
                    "path={}:name=vmat:enable_transform:disable_clip".format(
                        VmafConfig.test_resource_path("test_model_transform_add40_outltein.json")
                    ),
                ],
            },
            result_store=self.result_store,
...
class VmafexecQualityRunnerSubsamplingTest(MyTestCase):
    ...
    def test_run_vmafexec_runner_with_subsample2(self):
        ...
        for i in range(48):
            if i % subsample == 0:
                self.assertAlmostEqual(
                    results0[0]["VMAFEXEC_scores"][i],
                    results[0]["VMAFEXEC_scores"][i // subsample],
                    places=7,
                )
                self.assertAlmostEqual(
                    results0[1]["VMAFEXEC_scores"][i],
                    results[1]["VMAFEXEC_scores"][i // subsample],
                    places=7,
                )
